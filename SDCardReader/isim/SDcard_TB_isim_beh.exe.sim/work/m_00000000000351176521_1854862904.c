...
#endif
static const char *ng0 = "G:/SDCardReader/ExecuteCommand.v";
...
LAB45:    memcpy(t9, t12, 8);

LAB46:    t18 = (t0 + 2576);
    xsi_vlogvar_assign_value(t18, t9, 0, 0, 4);
    goto LAB20;
...
LAB62:    memcpy(t9, t43, 8);

LAB63:    t78 = (t0 + 2576);
    xsi_vlogvar_assign_value(t78, t9, 0, 0, 4);
    goto LAB20;
...
LAB29:    xsi_vlog_unsigned_bit_combine(t9, 4, t23, 4, t28, 4);
    goto LAB33;
...
LAB42:    xsi_vlog_unsigned_bit_combine(t9, 4, t11, 4, t12, 4);
    goto LAB46;

LAB44:    memcpy(t9, t11, 8);
    goto LAB46;
...
LAB75:    if (*((unsigned int *)t68) > 0)
        goto LAB76;

LAB77:    if (*((unsigned int *)t44) > 0)
        goto LAB78;

LAB79:    memcpy(t43, t77, 8);

LAB80:    goto LAB58;

LAB59:    xsi_vlog_unsigned_bit_combine(t9, 4, t23, 4, t43, 4);
    goto LAB63;

LAB61:    memcpy(t9, t23, 8);
    goto LAB63;
...
LAB76:    xsi_vlog_unsigned_bit_combine(t43, 4, t72, 4, t77, 4);
    goto LAB80;

LAB78:    memcpy(t43, t72, 8);
    goto LAB80;
...
LAB89:    xsi_vlog_unsigned_bit_combine(t9, 4, t11, 4, t12, 4);
    goto LAB93;

LAB91:    memcpy(t9, t11, 8);
    goto LAB93;

}


extern void work_m_00000000000351176521_1854862904_init()
{
	static char *pe[] = {(void *)Cont_36_0,(void *)Cont_37_1,(void *)Cont_38_2,(void *)Cont_39_3,(void *)Always_41_4,(void *)Always_51_5};
	xsi_register_didat("work_m_00000000000351176521_1854862904", "isim/SDcard_TB_isim_beh.exe.sim/work/m_00000000000351176521_1854862904.didat");
