...
#endif
static const char *ng0 = "D:/Code/Verilog/BitEpicness/ExecuteCommand.v";
...
LAB31:    xsi_vlog_unsigned_bit_combine(t9, 4, t23, 4, t28, 4);
    goto LAB35;
...
LAB44:    xsi_vlog_unsigned_bit_combine(t9, 4, t11, 4, t12, 4);
    goto LAB48;

LAB46:    memcpy(t9, t11, 8);
    goto LAB48;
...
LAB77:    if (*((unsigned int *)t68) > 0)
        goto LAB78;

LAB79:    if (*((unsigned int *)t44) > 0)
        goto LAB80;

LAB81:    memcpy(t43, t77, 8);

LAB82:    goto LAB60;

LAB61:    xsi_vlog_unsigned_bit_combine(t9, 4, t23, 4, t43, 4);
    goto LAB65;

LAB63:    memcpy(t9, t23, 8);
    goto LAB65;
...
LAB78:    xsi_vlog_unsigned_bit_combine(t43, 4, t72, 4, t77, 4);
    goto LAB82;

LAB80:    memcpy(t43, t72, 8);
    goto LAB82;
...
LAB91:    xsi_vlog_unsigned_bit_combine(t9, 4, t11, 4, t12, 4);
    goto LAB95;

LAB93:    memcpy(t9, t11, 8);
    goto LAB95;

}


extern void work_m_00000000000905717590_1854862904_init()
{
	static char *pe[] = {(void *)Cont_21_0,(void *)Cont_22_1,(void *)Cont_24_2,(void *)Cont_25_3,(void *)Always_27_4,(void *)Always_37_5};
	xsi_register_didat("work_m_00000000000905717590_1854862904", "isim/Main_TB_isim_beh.exe.sim/work/m_00000000000905717590_1854862904.didat");
