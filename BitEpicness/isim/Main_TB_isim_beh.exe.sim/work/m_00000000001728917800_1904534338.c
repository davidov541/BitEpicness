...
#endif
static const char *ng0 = "D:/Code/Verilog/BitEpicness/Decoder32bit.v";
...
LAB20:    t1191 = (t0 + 1684);
    ...
    t1195 = *((char **)t1194);
    memcpy(t1195, t3, 8);
    xsi_driver_vfirst_trans(t1191, 0, 31);
    t1196 = (t0 + 1640);
    *((int *)t1196) = 1;
...
LAB220:    xsi_vlog_unsigned_bit_combine(t434, 32, t465, 32, t470, 32);
    goto LAB224;
...
LAB237:    xsi_vlog_unsigned_bit_combine(t470, 32, t501, 32, t506, 32);
    goto LAB241;
...
LAB254:    xsi_vlog_unsigned_bit_combine(t506, 32, t537, 32, t542, 32);
    goto LAB258;
...
LAB271:    xsi_vlog_unsigned_bit_combine(t542, 32, t573, 32, t578, 32);
    goto LAB275;
...
LAB288:    xsi_vlog_unsigned_bit_combine(t578, 32, t609, 32, t614, 32);
    goto LAB292;
...
LAB305:    xsi_vlog_unsigned_bit_combine(t614, 32, t645, 32, t650, 32);
    goto LAB309;
...
LAB322:    xsi_vlog_unsigned_bit_combine(t650, 32, t681, 32, t686, 32);
    goto LAB326;
...
LAB339:    xsi_vlog_unsigned_bit_combine(t686, 32, t717, 32, t722, 32);
    goto LAB343;
...
LAB356:    xsi_vlog_unsigned_bit_combine(t722, 32, t753, 32, t758, 32);
    goto LAB360;
...
LAB373:    xsi_vlog_unsigned_bit_combine(t758, 32, t789, 32, t794, 32);
    goto LAB377;
...
LAB390:    xsi_vlog_unsigned_bit_combine(t794, 32, t825, 32, t830, 32);
    goto LAB394;
...
LAB407:    xsi_vlog_unsigned_bit_combine(t830, 32, t861, 32, t866, 32);
    goto LAB411;
...
LAB424:    xsi_vlog_unsigned_bit_combine(t866, 32, t897, 32, t902, 32);
    goto LAB428;
...
LAB441:    xsi_vlog_unsigned_bit_combine(t902, 32, t933, 32, t938, 32);
    goto LAB445;
...
LAB458:    xsi_vlog_unsigned_bit_combine(t938, 32, t969, 32, t974, 32);
    goto LAB462;
...
LAB475:    xsi_vlog_unsigned_bit_combine(t974, 32, t1005, 32, t1010, 32);
    goto LAB479;
...
LAB492:    xsi_vlog_unsigned_bit_combine(t1010, 32, t1041, 32, t1046, 32);
    goto LAB496;
...
LAB509:    xsi_vlog_unsigned_bit_combine(t1046, 32, t1077, 32, t1082, 32);
    goto LAB513;
...
LAB526:    xsi_vlog_unsigned_bit_combine(t1082, 32, t1113, 32, t1118, 32);
    goto LAB530;
...
LAB543:    xsi_vlog_unsigned_bit_combine(t1118, 32, t1149, 32, t1154, 32);
    goto LAB547;
...
LAB558:    t1190 = ((char*)((ng1)));
    goto LAB559;

LAB560:    xsi_vlog_unsigned_bit_combine(t1154, 32, t1185, 32, t1190, 32);
    goto LAB564;
...
extern void work_m_00000000001728917800_1904534338_init()
{
	static char *pe[] = {(void *)Cont_10_0};
	xsi_register_didat("work_m_00000000001728917800_1904534338", "isim/Main_TB_isim_beh.exe.sim/work/m_00000000001728917800_1904534338.didat");
